...
import com.example.cheng.Words.TypeMemoryWordActivity
import com.google.firebase.database.*


@Suppress("DEPRECATION")
class TypeMemoryTopic : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_type_memory_topic)
        ...
        databaseRef.child("Topic/Sixth_topic/Toc").addValueEventListener(object :
            ValueEventListener
        {
        ...
        databaseRef.child("Topic/Sixth_topic/Text").addValueEventListener(object :
            ValueEventListener
        {
            override fun onDataChange(snapshot: DataSnapshot) {
...
//        Glide.with(this).load(UrlImage1).into(Photo)
        ...
        btn1.setOnClickListener {
            val intent = Intent(this, TypeMemoryWordActivity::class.java)
