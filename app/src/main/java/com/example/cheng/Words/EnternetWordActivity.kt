...
class EnternetWordActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_enternet_word)
        ...
        val ref = FirebaseDatabase.getInstance().reference.child("Words/Second_topic")
        ...
        val btn1 = findViewById<Button>(R.id.backTopicEnternet)
