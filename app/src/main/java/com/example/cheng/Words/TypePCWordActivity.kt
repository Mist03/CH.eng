...
class TypePCWordActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_type_pcword)
        val btn1 = findViewById<Button>(R.id.backTopicTypePC)
        ...
        val ref = FirebaseDatabase.getInstance().reference.child("Words/Fourth_topic")
