...
class CPUWordActivity : AppCompatActivity() {


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cpuword)
        val btn1 = findViewById<Button>(R.id.backTopicCPU)
        ...
        val ref = FirebaseDatabase.getInstance().reference.child("Words/Fifth_topic")
